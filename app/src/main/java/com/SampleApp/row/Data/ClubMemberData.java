...
public class ClubMemberData {
    String masterUID, grpID, profileID, memberName, membermobile, pic, distDesignation;

    public ClubMemberData(String masterUID, String grpID, String profileID, String memberName, String membermobile, String pic, String distDesignation) {
