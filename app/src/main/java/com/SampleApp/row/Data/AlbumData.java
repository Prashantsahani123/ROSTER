...
public class AlbumData implements Serializable {
    ...
    String project_date,project_cost,beneficiary,working_hour,working_hour_type,cost_of_project_type,noOfRotarians;
    ...
    public AlbumData(String albumId, String title, String description, String image, String grpId, String isAdmin, String moduleId, String cat_id, String cat_name, boolean isSelected, String district_id, String district_Name, String club_id, String club_Name, String project_date, String project_cost, String beneficiary, String working_hour, String working_hour_type, String cost_of_project_type, String noOfRotarians) {
        this.albumId = albumId;
        this.title = title;
        this.description = description;
        this.image = image;
