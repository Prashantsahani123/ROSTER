...
public class E_Bulletin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = getIntent().getExtras().getString("moduleName", "Newsletters");
...
//        }else {
//
//            Utils.showToastWithTitleAndContext(E_Bulletin.this,getString(R.string.noInternet));
//        }
