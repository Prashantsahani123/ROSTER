...
public class FindRotatrianActivity extends Activity {
    ...
    EditText edtname,edt_classification,edt_city,edt_districtNo;
    ...
    public boolean validation(){
        if(edtname.getText().toString().equalsIgnoreCase("")&& edt_classification.getText().toString().equalsIgnoreCase("") && edt_city.getText().toString().equalsIgnoreCase("") && edt_districtNo.getText().toString().equalsIgnoreCase("")){
            return false;
        }
        return true;
    }
