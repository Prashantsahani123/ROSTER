...
//                    tv_date.setText(displayDate +dd+" " + "Events:");
    ...
    public void checkForUpdate() {
        ...
        updatedOn = PreferenceManager.getPreference(context, TBPrefixes.CALENDAR_UPDATED_ON + grpId + selecteddate);
    ...
    public void webservices() {
        ...
        updatedOn = PreferenceManager.getPreference(context, TBPrefixes.CALENDAR_UPDATED_ON + grpId + selecteddate, "1970/01/01 00:00:00");
        Utils.log("Last updated date is" + updatedOn);
        arrayList.add(new BasicNameValuePair("updatedOn", updatedOn));
                ...
                Handler calendarEventsHandler = new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        if (!saved) {
                            ...
                            PreferenceManager.savePreference(context, TBPrefixes.CALENDAR_UPDATED_ON + grpId + selecteddate, updatedOn);
                            gridAdapter = new MonthViewGridAdapter(getApplicationContext(), R.id.date, month, year, grpId);
