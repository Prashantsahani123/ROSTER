...
import com.NEWROW.row.EditMember;
import com.NEWROW.row.Inteface.StartActivityForResultInterface;
import com.NEWROW.row.R;
import com.NEWROW.row.SelectCountry;

import java.util.ArrayList;
import java.util.regex.Pattern;

import static com.NEWROW.row.EditMember.list_contactData;
