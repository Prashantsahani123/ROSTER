...
public class FragmentALLAdapter extends BaseAdapter {
   ...
   /* public Gallery_adapter(Gallery mainActivity, String[] prgmNameList, int[] prgmImages) {
    ...
    public FragmentALLAdapter(Context cnt, String[] prgmImages) {
        // TODO Auto-generated constructor stub
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.fragment_grp_all_item, null);
